...
export default function EmaileventMaster() {
  ...
  const accept = () => {
    ...
    api
      .post(`Comm/DeleteEventSetting`, collectData)
      .then((response) => {
    ...
    try {
      ...
      if (data.length > 0) {
        const columns: GridColDef[] = [
          ...
          {
            field: "eventType",
            headerName: t("text.Emaileventtype1"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
