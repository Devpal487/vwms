...
export default function EmailcampgianMaster() {
    ...
    try {
      ...
      if (data.length > 0) {
        const columns: GridColDef[] = [
          ...
          {
            field: "campaignName",
            headerName: t("text.Emailcampaigname1"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
            field: "campaignDate",
            headerName: t("text.Emailcampgiandate"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
