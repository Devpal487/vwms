...
export default function PollMaster() {
  ...
  const routeChangeEdit = (row: any) => {
    ...
    let path = `/master/PollMasterEdit`;
    navigate(path, {
      state: row,
    });
  };
  ...
  const accept = () => {
    ...
    api
      .delete( `PoleMaster/DeletePoleMaster`, {data:collectData})
      .then((response) => {
        if (response.data.isSuccess) {
          toast.success(response.data.mesg);
        } else {
    ...
    try {
      ...
      if (data.length > 0) {
        const columns: GridColDef[] = [
          ...
          {
            field: "poleName",
            headerName: t("text.poleName"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
            field: "hight",
            headerName: t("text.Hight"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
            field: "wight",
            headerName: t("text.wight"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
            field: "thickness",
            headerName: t("text.Thickness"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
