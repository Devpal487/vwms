...
import Languages from "../../../utils/Languages";
  ...
  const EditItemMaster = (props: Props) => {
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values) => {
        const response = await api.post(
           `ItemMaster/AddUpdateItemMaster`,
          values
        );
                  ...
                  <Autocomplete
                    ...
                    value={
                      itemgroupOptions.find(
                        (opt:any) => opt.value === formik.values.itemGroupId
                      ) || null
                    }
                    renderInput={(params) => (
                      <TextField
