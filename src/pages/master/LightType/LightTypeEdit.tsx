...
const LightTypeEdit = (props: Props) => {
  ...
  const formik = useFormik({
    initialValues: {
        lightId:location.state.lightId,
        waitege:location.state.waitege,
      
        volt:location.state.volt,
        wire:location.state.wire,
        color:location.state.color,
        weight:location.state.weight,
        lightColor:location.state.lightColor,
